package com.hotel.booking.system.kafka.consumer.config;

import com.hotel.booking.system.kafka.config.KafkaConfigData;
import com.hotel.booking.system.kafka.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K, V> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, kafkaConsumerConfigData.getSpringJsonTrustedPackages());
        return props;
    }
