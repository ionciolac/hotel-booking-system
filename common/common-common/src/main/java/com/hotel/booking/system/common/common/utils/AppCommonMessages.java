...
public class AppCommonMessages {
    ...
    public static final String SERVICE_CUSTOMER_ALREADY_EXIST_MESSAGE = "Customer with same username, phoneNumber and email already exist in DB.";
    ...
    public static final String SERVICE_CUSTOMER_ALREADY_ADDED_FEEDBACK_MESSAGE = "Customer with id: %s already added feedback to %s with id %s";
    ...
    public static final String SERVICE_BOOKING_IS_ALREADY_EXIST_MESSAGE = "Booking room id: %s by customer id: %s from date: %s to date: %s already exist.";
