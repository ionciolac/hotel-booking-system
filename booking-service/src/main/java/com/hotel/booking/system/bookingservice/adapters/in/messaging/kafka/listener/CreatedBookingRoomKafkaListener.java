...
@Component
public class CreatedBookingRoomKafkaListener implements KafkaConsumer<CreateBookingMessage> {

    private final CreatedBookingRoomListener createdBookingRoomListener;
    ...
    public void receive(@Payload List<CreateBookingMessage> messages,
        ...
        messages.forEach(message -> createdBookingRoomListener
                .bookingCreated(bookingRoomListenerMapper.toBooking(message)));
    }
}
